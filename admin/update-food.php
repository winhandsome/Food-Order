...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = $db->query("SELECT * FROM tbl_food WHERE id=$id");
        $row2 = $sql2->fetchArray(SQLITE3_ASSOC);
    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql3 = $db->query("UPDATE tbl_food
                SET title = '$title', description = '$description', price = $price, image_name = '$image_name', category_id = '$category', featured = '$featured', active = '$active'
                WHERE id=$id");
